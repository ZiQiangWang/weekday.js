 ...
 * @return   {Boolean}         判断结果
 */
weekday.prototype.check = function(date) {
 ...
 * @return   {Array}           日期列表
 */
weekday.prototype.range = function(start, end, format) {
    ...
    return this.format_weekdays(weekday_list, format);
}
 ...
 */
weekday.prototype.in = function(days, format, origin) {
    ...
    return this.range(offset, now, format);
}
 ...
 * @return   {Array}            返回的日期列表
 */
weekday.prototype.recent = function(days, format, origin) {
 ...
 */
weekday.prototype.format_weekdays = function(weekday_list, format) {
    if (format === undefined) {
        return weekday_list;
    } else {
        var _this = this;
        return weekday_list.map(function(item){
            return _this.format(item, format);
        });
    }
}
 ...
 */
weekday.prototype.format = function(mydate,format) {
